import svgPaths from "./svg-tl0pe9e9jw";
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[290px] top-[933px] w-[187px]">
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[9px] items-start left-[56px] top-[650px] w-[205px]">
      <Frame4 />
      <Frame5 />
    </div>
  );
...
export default function MacBookPro() {
  return (
    <div className="bg-white relative size-full" data-name="MacBook Pro 14' - 21">
